...
@Component({
  ...
  templateUrl: './home.html', // Make sure this path is correct if your file is home.html and not home.component.html
})
export class Home implements OnInit { // Implement OnInit for ngOnInit lifecycle hook
  isAuthenticated = false; // Initialize to false, will be checked in ngOnInit
  ...
  ngOnInit(): void {
    // This is a more robust way to check authentication on component initialization
    // It's generally better to use a dedicated authentication service for this.
